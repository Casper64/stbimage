...
STBIRDEF int stbir_resize_uint16_generic(const u16 *input_pixels  , int input_w , int input_h , int input_stride_in_bytes,
                                               u16 *output_pixels , int output_w, int output_h, int output_stride_in_bytes,
                                         int num_channels, int alpha_channel, int flags,
                                         stbir_edge edge_wrap_mode, stbir_filter filter, stbir_colorspace space,
                                         void *alloc_context);
...
typedef unsigned char stbir__validate_uint32[sizeof(u32) == 4 ? 1 : -1];
...
static stbir__inline u8 stbir__saturate8(int x)
{
...
static stbir__inline u16 stbir__saturate16(int x)
{
...
static u8 stbir__linear_to_srgb_uchar(float in)
{
...
static u8 stbir__linear_to_srgb_uchar(float f)
{
...
static void stbir__encode_scanline(stbir__info* stbir_info, int num_pixels, void *output_buffer, float *encode_buffer, int channels, int alpha_channel, int decode)
{
    ...
    int n;
    int num_nonalpha;
    u16 nonalpha[STBIR_MAX_CHANNELS];
    ...
    for (x = 0, num_nonalpha = 0; x < channels; ++x)
    {
        ...
        {
            nonalpha[num_nonalpha++] = (u16)x;
        }
    }

    #define STBIR__ROUND_INT(f)    ((int)          ((f)+0.5))
    #define STBIR__ROUND_UINT(f)   ((u32) ((f)+0.5))
...
static u32 stbir__calculate_memory(stbir__info *info)
{
...
static int stbir__resize_allocated(stbir__info *info,
    ...
    int alpha_channel, u32 flags, stbir_datatype type,
...
static int stbir__resize_arbitrary(
    ...
    int channels, int alpha_channel, u32 flags, stbir_datatype type,
